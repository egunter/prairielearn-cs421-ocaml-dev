 ...
 ***************************/
  $('#proofTreeButtonSave').on('click', function(e) {
    ...
    var conditionClause = $('#proofTreeModalAnsCondition').val().length > 0 ? ":" : "";
    var style = '';
 ...
 ***************************/
  $('#proofTreeButtonEdit').on('click', function(e) {
    ...
    conditionClause = ($('#proofTreeModalAnsCondition').val().length > 0) ? ":" : "";
    console.log($('#proofTreeModalAnsCondition').val())
    //} else {
 ...
 ***************************/
  ...
  $(document).ready(function() {
    // What we want to do is be able to define (per instance) what the operator
    // should be.
    //
    // TODO make this be dependent upon the question type.
    if (window.operator == undefined) {
      window.operator = "Downarrow";
    }
