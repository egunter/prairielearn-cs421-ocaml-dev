...
%start memory program side_condition thing_to_eval eval_result term_mem_pair
...
%type <Common.eval_result> eval_result
...
eval_result:
  | MINUS INT                       { IntResult (- $2) }
  | INT                              { IntResult $1 }
  | TRUE                            { BoolResult true }
  | FALSE                            { BoolResult false }
  | memory                              { MemoryResult $1 }
