...
(* let id_ext = (alphanum | "'" | "_" )* *)
let id_ext = (alphanum "_" )*
let id = lower_case id_ext | upper (id_ext*) "." (id_ext+)
let ty_var = "'" id
let weird_ty_var = id "'"
...
let try_get_all_tokens s =
    ...
    with Failure s -> (
        if s = "unmatched open comment" then (None, true)
        else if s = "unmatched closed comment" then (None, false)
